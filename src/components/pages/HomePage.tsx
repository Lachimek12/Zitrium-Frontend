        ...
        <div className="text-center">
          <header className="bg-[#282c34] min-h-screen flex flex-col items-center justify-center text-white text-[calc(10px+2vmin)]">
            ...
            <div className='flex gap-2.5 pt-12'>
              <button className='text-black bg-[#8a2be2] active:bg-[#388bc5] border-black text-lg p-5 px-7.5 border-0.5 cursor-pointer' onClick={handleReceiveButton}>Receive</button>
              <button className='text-black bg-[#8a2be2] active:bg-[#388bc5] border-black text-lg p-5 px-7.5 border-0.5 cursor-pointer' onClick={handleSendButton}>Send</button>
            </div> 
            ...
            <div>
              {(response.data == null) ? (
                ...
                <p>{response.data.name} {response.data.email}</p>
              )}
            </div>
          </header>
        </div>
